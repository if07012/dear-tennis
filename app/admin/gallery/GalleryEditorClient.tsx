      ...
      <section className="rounded-2xl border border-light-gray bg-white p-6">
        <header className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-dark-gray">
              Kartu foto yang tampil di section Gallery home page. Tandai
              sebagai &quot;Featured&quot; untuk menempatkannya sebagai tile besar
              (2×2).
            </p>
          </div>
          <button
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex w-24 flex-shrink-0 flex-col items-center gap-1">
                    <div className="relative h-20 w-20 overflow-hidden rounded-xl bg-light-gray">
                      {item.src ? (
                  ...
                  <div className="flex flex-1 flex-col gap-3 min-w-0">
                    ...
                    <label className="flex flex-col gap-1">
                      <span className={FIELD_LABEL_CLS}>Alt text</span>
                      <input
                        type="text"
                        value={item.alt}
                        onChange={(e) =>
                    ...
                    <label className="inline-flex items-center gap-2 self-start text-xs text-dark-gray">
                      <input
                        ...
                        onChange={(e) =>
                          updateItem(item.id, { large: e.target.checked })
                        }
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-3 border-t border-light-gray pt-4">
          <p className="text-xs text-dark-gray">
            ...
            {Math.min(pageStart + pageSize, total)} dari {total} foto · Halaman{' '}
